...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-modal-index', __webpack_require__(3));
  Vue.component('detail-modal-index', __webpack_require__(6));
  Vue.component('form-modal-index', __webpack_require__(9));
});
